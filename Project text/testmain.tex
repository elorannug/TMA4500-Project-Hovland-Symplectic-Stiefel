...
% Modified by Ole Gunnar Røsholt Hovland
...
\usepackage[backend = biber,    % Recommended backend for sorting bibliography
            ...
            style = numeric, % Changed by Ole Gunnar
...
% Added by Ole Gunnar Røsholt Hovland:
\usepackage{cancel}     % To be able to cross out terms
...
% --- Other tools ---
\usepackage{todonotes} % Add to-do notes in the document
% \usepackage{cleveref} % Clever references, e.g. \cref{label} will produce "equation (1)" or "figure 1" depending on what is referenced
% % % % Define custom names for the algorithm environment
...
% \begingroup
% \renewcommand\thealgorithm{} % Disable cleveref's handling of numbering
