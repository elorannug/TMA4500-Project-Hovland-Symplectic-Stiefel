\subsection{The Real Symplectic group}
...
\end{equation}
The symplectic group is defined as the set of matrices which satisfy the symplectic condition in the following sense. We define the real symplectic group as %is a quotient space of the general linear group (defined in Definition~\ref{def:general_linear_group}). 
