...
\end{equation}
The symplectic group is defined as the set of matrices which define the symplectic structure in the following sense. We define the real symplectic group as %is a quotient space of the general linear group (defined in \Cref{def:general_linear_group}). 
